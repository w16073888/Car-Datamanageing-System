...
CREATE TABLE t_employee (
    ...
    position        ENUM('经理','前台','库管','客服') NOT NULL  COMMENT '职位',
...
-- 插入默认管理员（密码: admin123 的SHA256）
INSERT INTO t_employee (employee_id, name, password, position, phone) VALUES
('ADMIN001', '系统管理员', '240be518fabd2724ddb6f04eeb1da5967448d7e831c08c8fa822809f74c720a9', '经理', '13800000000');
...
CREATE TABLE t_workorder (
    ...
    vehicle_id      INT             NOT NULL                   COMMENT '关联车辆ID',
    technician_id   INT                                        COMMENT '维修责任人(员工ID)',
    mileage         INT                                        COMMENT '当前公里数',
    repair_content  TEXT                                       COMMENT '报修内容',
    labor_fee       DECIMAL(10,2)   DEFAULT 0.00              COMMENT '预估工时费',
    total_amount    DECIMAL(10,2)   DEFAULT 0.00              COMMENT '总金额',
    status          ENUM('待派工','维修中','已完工','已结算')
...
CREATE TABLE t_inventory_log (
    ...
    quantity        INT             NOT NULL                   COMMENT '数量(正=入库/退库, 负=出库/退货)',
    unit_price      DECIMAL(10,2)                              COMMENT '单价(出入库时的价格)',
    total_price     DECIMAL(10,2)                              COMMENT '总价',
    operation_type  ENUM('采购入库','维修出库','备件退库','采购退货','盘点调整')
