...
namespace {
struct qt_meta_tag_ZN15DataManagerPageE_t {};
} // unnamed namespace

template <> constexpr inline auto DataManagerPage::qt_create_metaobjectdata<qt_meta_tag_ZN15DataManagerPageE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<DataManagerPage, qt_meta_tag_ZN15DataManagerPageE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject DataManagerPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15DataManagerPageE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15DataManagerPageE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15DataManagerPageE_t>.metaTypes,
    nullptr
} };
...
void *DataManagerPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15DataManagerPageE_t>.strings))
